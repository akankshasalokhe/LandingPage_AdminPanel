...
const Carou = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://biz-booster-landingpage-backend.vercel.app/api/images/get')
      .then((response) => {
  ...
  const handleAddDesign = async () => {
    ...
    try {
      const response = await axios.post('https://biz-booster-landingpage-backend.vercel.app/api/images/insert', formData, {
  ...
  const handleDeleteDesign = async (id) => {
    ...
    try {
      await axios.delete(`https://biz-booster-landingpage-backend.vercel.app/api/images/delete/${id}`);
